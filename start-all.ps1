...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$rootPath\src\VatIT.Worker.Validation'; dotnet run"

Start-Sleep -Seconds 2

# Start Applicability Worker
Write-Host "Starting Applicability Worker on port 8002..." -ForegroundColor Cyan
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$rootPath\src\VatIT.Worker.Applicability'; dotnet run"

Start-Sleep -Seconds 2

# Start Exemption Worker
Write-Host "Starting Exemption Worker on port 8003..." -ForegroundColor Cyan
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$rootPath\src\VatIT.Worker.Exemption'; dotnet run"

Start-Sleep -Seconds 2

# Start Calculation Worker
Write-Host "Starting Calculation Worker on port 8004..." -ForegroundColor Cyan
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$rootPath\src\VatIT.Worker.Calculation'; dotnet run"

Start-Sleep -Seconds 3

# Start Orchestrator API
Write-Host "Starting Orchestrator API on port 5100..." -ForegroundColor Cyan
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$rootPath\src\VatIT.Orchestrator.Api'; dotnet run"
